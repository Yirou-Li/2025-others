...
# 输入文件路径
input_file = "/home/lyr/Microbial_fermentation/CGMCC/Geobacillus_fasta/prokka_output/BA000043.1/BA000043.1.tsv"
# 输出文件路径
output_file = "/home/lyr/Microbial_fermentation/CGMCC/Geobacillus_fasta/prokka_output/BA000043.1/BA000043.1_ko.tsv"
# 临时文件路径
temp_file = "/home/lyr/Microbial_fermentation/CGMCC/Geobacillus_fasta/prokka_output/BA000043.1/BA000043.1_ko_temp.tsv"
...
def get_kegg_ids(query, query_type, retries=3, delay=60):
    if pd.isna(query) or query == "":
        return []
    if query_type == "COG":
        url = f"https://www.genome.jp/dbget-bin/www_bfind_sub?mode=bfind&max_hit=1000&dbkey=kegg&keywords={query}"
    elif query_type == "EC":
